"""
Loop through visualizations of autocorrelation functions of kinematic quantities.
"""
...
for quantity in QUANTITIES:
    ...
    for ax, expt in zip(axs, expts):
        for color, odor_state in zip(DATA_COLORS, ODOR_STATES):
            ...
            ax.plot(tpa.time_vector, tpa.autocorrelation, color=color, lw=LW)
            ax.fill_between(tpa.time_vector, tpa.confidence_lower, tpa.confidence_upper,
